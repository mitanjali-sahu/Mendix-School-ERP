...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("EventApplication.EventPhoto", mendixObject.getType()))
			return eventapplication.proxies.EventPhoto.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("EventApplication.SpeakerPhoto", mendixObject.getType()))
